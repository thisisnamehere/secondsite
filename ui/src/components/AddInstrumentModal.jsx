...
function AddInstrumentModal({ onClose, onSubmit }) {
      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-4 sm:mb-6 gap-2">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-apple-dark">Добавить инструмент</h2>
            <button
              onClick={onClose}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Например: Скальпель хирургический"
                  {...register('name', {
